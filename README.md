# Earth Presentation Generator

This repository contains a Python script to generate a PowerPoint presentation about Planet Earth.
...
python create_earth_ppt.py
```

This will generate `Earth_Presentation.pptx` in the current directory.
